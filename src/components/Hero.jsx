  ...
  return (
    ...
    >
      ...
      >
        ...
        <h1 className="font-poppins font-semibold ss:text-[68px] text-[52px] ss:leading-[80px] leading-[80px] w-full bg-gradient-wave bg-clip-text text-transparent animate-wave bg-[length:200%_100%]">
          {aboutMe.name}
        </h1>
